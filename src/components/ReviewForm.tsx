    ...
    return (
      <section className="py-28 md:py-36 bg-white">
        <div className="max-w-2xl mx-auto px-6 text-center">
          <h1 className="font-script text-5xl text-brand-900 mb-6">
            {successHeading || "Thank You!"}
          </h1>
          <p className="text-[14px] text-brand-600 leading-[1.8]">
            {successMessage || "Your review has been submitted and is pending approval. We truly appreciate you taking the time to share your experience."}
          </p>
        </div>
      </section>
    );
      ...
      <section className="py-24 bg-white">
        <div className="max-w-lg mx-auto px-6">
          <p className="text-[14px] text-brand-600 text-center mb-10 leading-[1.8]">
            {description || "We'd love to hear about your experience with Gigi's Concept. Your feedback means the world to us."}
          </p>
