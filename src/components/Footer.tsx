        ...
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <Link href="/pricing" className="text-sm hover:text-white transition-colors">Build Your Quote</Link>
          ...
          <div>
            ...
            <p className="text-sm mb-4">hello@gigisconcept.com</p>
            <div className="flex gap-4">
              ...
              <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="hover:text-white transition-colors">
