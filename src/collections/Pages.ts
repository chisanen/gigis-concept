...
const HeroBlock: Block = {
  ...
  fields: [
    ...
    { name: "backgroundImage", type: "upload", relationTo: "media", admin: { description: "The large background image for the hero section" } },
...
const AboutSplitBlock: Block = {
  ...
  fields: [
    ...
    { name: "image", type: "upload", relationTo: "media", admin: { description: "Photo displayed alongside the about text" } },
    { name: "isVisible", type: "checkbox", defaultValue: true, admin: { description: "Uncheck to hide this section without deleting it" } },
  ],
};
...
const TwoWaysBlock: Block = {
  ...
  fields: [
    ...
    { name: "card1Image", type: "upload", relationTo: "media", admin: { description: "Image for the first service card" } },
    ...
    { name: "card2Image", type: "upload", relationTo: "media", admin: { description: "Image for the second service card" } },
