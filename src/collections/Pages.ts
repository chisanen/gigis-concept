...
const HeroBlock: Block = {
  ...
  fields: [
    ...
    { name: "backgroundImage", type: "upload", relationTo: "media", admin: { components: { afterInput: ["@/components/admin/AIImageButton#AIImageButton"] }, description: "Hero background image or video. Upload here to replace the default." } },
    { name: "slide2", type: "upload", relationTo: "media", admin: { description: "Second carousel slide (optional)" } },
    { name: "slide3", type: "upload", relationTo: "media", admin: { description: "Third carousel slide (optional)" } },
    { name: "slide4", type: "upload", relationTo: "media", admin: { description: "Fourth carousel slide (optional)" } },
    { name: "slide5", type: "upload", relationTo: "media", admin: { description: "Fifth carousel slide (optional)" } },
...
const GalleryBlock: Block = {
  ...
  fields: [
    ...
    { name: "photo1", type: "upload", relationTo: "media", admin: { description: "Gallery photo 1" } },
    { name: "photo2", type: "upload", relationTo: "media", admin: { description: "Gallery photo 2" } },
    { name: "photo3", type: "upload", relationTo: "media", admin: { description: "Gallery photo 3" } },
    { name: "photo4", type: "upload", relationTo: "media", admin: { description: "Gallery photo 4" } },
    { name: "photo5", type: "upload", relationTo: "media", admin: { description: "Gallery photo 5" } },
    { name: "photo6", type: "upload", relationTo: "media", admin: { description: "Gallery photo 6" } },
    { name: "photo7", type: "upload", relationTo: "media", admin: { description: "Gallery photo 7" } },
    { name: "photo8", type: "upload", relationTo: "media", admin: { description: "Gallery photo 8" } },
    { name: "isVisible", type: "checkbox", defaultValue: true, admin: { description: "Uncheck to hide this section without deleting it" } },
  ],
};
